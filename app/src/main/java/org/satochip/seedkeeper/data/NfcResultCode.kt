...
enum class  NfcResultCode(val resTitle : Int, val resMsg : Int, val resImage : Int, var triesLeft: Int? = null) {
    ...
    SECRET_HEADER_LIST_SET(R.string.nfcTitleSuccess, R.string.secretHeaderListSet, R.drawable.icon_check_gif, null), // TODO merge with  CARD_SUCCESSFULLY_SCANNED?
    ...
    SECRETS_EXPORTED_SUCCESSFULLY_FROM_MASTER(R.string.nfcTitleSuccess, R.string.cardSuccessfullyScanned, R.drawable.icon_check_gif, null), //TODO titles
